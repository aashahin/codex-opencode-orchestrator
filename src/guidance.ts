...
- Carry this transport requirement, original repoDir, bridge worker UUIDs, model and requested variant/reasoning effort, scope, patch review/application status, and next MCP action into every handoff or compaction summary. Discover exact variants with oc_models and preserve the selection on follow-up work. A previous CLI command in a summary is history, not authorization to repeat it.
