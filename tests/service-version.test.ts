...
test("admits stable compatible releases without pinning every patch", () => {
  for (const version of ["2.0.3", "2.0.4", "2.1.0", "2.10.12"])
    expect(() => assertSupportedService({ healthy: true, version })).not.toThrow();
});

test("rejects prereleases, unsupported majors, old runtimes, and unhealthy services", () => {
  for (const version of ["", "1.9.0", "2.0.0", "2.0.1", "2.0.2", "3.0.0", "2.0.3-beta.1", "0.0.0-beta-19271", "2.0.3+build", "2.00.3", "2.0.03", "2.0.3\n"])
